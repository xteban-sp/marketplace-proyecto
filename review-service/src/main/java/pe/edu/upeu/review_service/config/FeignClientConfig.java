package pe.edu.upeu.review_service.config;
...
import pe.edu.upeu.review_service.security.ServiceTokenProvider;

/**
 * Interceptor global de Feign: reenvia el header Authorization de la peticion
 * entrante a las llamadas salientes. Si no hay token de usuario, adjunta un
 * token de servicio.
 */
@Configuration
